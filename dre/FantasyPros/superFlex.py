...
def runSuperFlex():
  ...
  response = requests.get('https://www.fantasypros.com/nfl/rankings/dynasty-superflex.php')
  soup = BeautifulSoup(response.content, 'html.parser')
  
  # complete =  soup.find("div", {"id": "rankings-app"})
  complete = soup.find("div", class_="inner")
  # print(complete)

  combined = complete.find_all("div", class_="ranking-header-wrap--padding-one-banner")
  print(combined[0])
