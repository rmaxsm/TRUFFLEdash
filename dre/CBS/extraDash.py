...
def getExtraDash(week, season):
  ...
  cookies = {
    ...
    'RT': '"z=1&dm=cbssports.com&si=b9dffa3-220c-4ad8-b659-7a3652cfd527&ss=l2ugg8aa&sl=1&tt=2mc&bcn=%2F%2Fb8a9a27e.akstat.io%2F&ul=2mc&ld=3dj&hd=3mx"',
    'XFP_FIRSTPAGE': '0',
